...
typedef struct {
	int fileDesc; // Number when the file opens
	int max_records; // Maximun number of records a block can have
	int index_last_block; // Index of the last block
	int recs_last_block; // Number of records the last block has
	char type[5]; // Code word in order to check if it's a heap file
	BF_Block *first_block; // Pointer to the first block
} HP_info;
