...
#define BF_BUFFER_SIZE 100     // Ο μέγιστος αριθμός block που κρατάμε στη μνήμη
...
typedef enum BF_ErrorCode {
	...
	BF_FILE_ALREADY_EXISTS,        // Το αρχείο δεν μπορεί να δημιουργηθεί γιατί υπάρχει ήδη
	...
	BF_AVAILABLE_PIN_BLOCKS_ERROR, // Το αρχείο δεν μπορεί να κλείσει επειδή υπάρχουν ενεργά Block στη μνήμη
	BF_ERROR
} BF_ErrorCode;
...
// Η συνάρτηση BF_Block_Destroy αποδεσμεύει τη μνήμη που καταλαμβάνει η δομή BF_BLOCK.
...
/* Η συνάρτηση BF_Βlock_GetData επιστρέφει έναν δείκτη στα δεδομένα του Block.
Άμα αλλάξουμε τα δεδομένα θα πρέπει να κάνουμε το block dirty με την κλήση
...
Μπορούμε να επιλέξουμε ανάμεσα σε δύο πολιτικές αντικατάστασης Block
...
filename και επιστρέφει το αναγνωριστικό του αρχείου στη μεταβλητή
...
διαθέσιμων block του, τον οποίο και επιστρέφει στην μεταβλητή blocks_num.
...
στη μνήμη (pin) και επιστρέφεται στη μεταβλητή block. Όταν δεν το
χρειαζόμαστε άλλο αυτό το block τότε πρέπει να ενημερώσουμε το επίπεδο
block καλώντας τη συνάρτηση BF_UnpinBlock. Σε περίπτωση επιτυχίας
...
το block τότε πρέπει να ενημερώσουμε το επίπεδο block καλώντας τη συνάρτηση
...
οποίο κάποια στιγμή θα το γράψει στον δίσκο. Σε περίπτωση επιτυχίας
επιστρέφεται BF_OK ενώ σε περίπτωση αποτυχίας, επιστρέφεται ένας κωδικός
λάθους. Αν θέλετε να δείτε το είδος του λάθους μπορείτε να καλέσετε τη
συνάρτηση BF_PrintError. */
...
στο stderr μια περιγραφή του σφάλματος. */
